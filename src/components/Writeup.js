...
const Writeup = (props) => {
    return (
        <div className= "writeup">
            ...
            <p id="writeupBody">
                I returned home from living in China in late 2019 and decided to pursue a career in software development. Spending a couple of months preparing for technical interviews and bolstering my skills by developing some side projects, I was ready to apply starting in February of 2020. Unfortunately, the breakout of Corona Virus in the US was right around the corner. This dashboard visualizes what my job search has looked like for the last few months; I imagine many people out there are having similar struggles.<br></br><br></br>
